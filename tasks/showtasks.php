<?php
  ...
  $myid = $_SESSION['userId'];
   ...
   ?>
    ...
    <title>Pokaż Zlecenia</title>
  </body>
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h1">Pokaż Zlecenia</h1>
        
      </div>
   <h1 class="h4">Krytera:</h1>
<div class="col-md-7 col-lg-8">
        <form class="needs-validation" action="..\assets\fun\findtask.php" method="post">
          <div class="row g-3">
            <div class="col-md-2">
   ...
   <?php
                ...
                if(isset($_GET['all'])){
                  ...
                  $sdate= ''.$data.' 00:00:00';
                    ...
                    AND (:area="" OR tasks.area_id = :area) 
                    AND (:task="" OR tasks.task_id = :task) 
                    AND (:typ="" OR tasks.type_id = :typ) 
                    AND (:place="" OR tasks.place = :place)  
                    AND (:street="" OR tasks.street = :street)
                    AND (:streetnr="" OR tasks.place_number = :streetnr)
                    AND (:stat="" OR tasks.task_status_id = :stat)
                    AND (:data1="" OR tasks.time_set BETWEEN :f1data AND :f2data )
