   ...
   if(isset($_SESSION['userId'])){?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h1">Ustaw nowy czas realizacji</h1>
...
<div class="col-md-7 col-lg-8">
        ...
        <input type="date"  name="date" id ="date" class="form-control"
              value="'.date("Y-m-d").'"
              min="'.date("Y-m-d").'"> <button class="btn btn-primary btn-sm" type="submit" name="udate-submit">Wybierz</button></form></h1>';


              if(isset($_POST['udate-submit'])){ 
                ...
                if($findtt== 1 || $findtt == 2 || $findtt == 3){
                  ...
                  for ($i = $findhmN; $i < 4; $i++) {
                    ...
                    if($t8==0){
                      ...
                      echo '<td> <button type="submit"  class="btn btn-success btn-sm" name="updatedate-submit">Wybierz</button></td><form></tr>';
                    }
                    elseif($t11==0){
                      $t10=1;
